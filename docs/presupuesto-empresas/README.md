...
| [alcance-mvp-presupuesto-tecnico-viewer.html](./alcance-mvp-presupuesto-tecnico-viewer.html)       | **Alcance MVP** — lectura en navegador (PDF.js; sin enlace directo de descarga en la UI). El PDF auxiliar solo se usa como recurso interno del visor. |
...
- `https://gimaddmentor.github.io/GimaddMentor/docs/presupuesto-empresas/alcance-mvp-presupuesto-tecnico-viewer.html` (Alcance MVP, vista en navegador)
